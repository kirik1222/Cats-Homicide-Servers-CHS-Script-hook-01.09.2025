...
-- Misc --
ENT.PrintName = "Elmo (MOD)"
ENT.Category = "Poppy Playtime"
ENT.Models = {"models/mentrillum/poppyplaytime/gmod_port/mod/huggy_elmo.mdl"}
ENT.Skins = {0}
ENT.ModelScale = 1.0
...
ENT.OnSpawnSounds = {}
ENT.OnIdleSounds = {
	"elmo/voice/idle/hunter_stalk_01.wav",
	"elmo/voice/idle/hunter_stalk_04.wav",
	"elmo/voice/idle/hunter_stalk_05.wav",
	"elmo/voice/idle/hunter_stalk_06.wav",
	"elmo/voice/idle/hunter_stalk_07.wav",
	"elmo/voice/idle/hunter_stalk_08.wav",
	"elmo/voice/idle/hunter_stalk_09.wav",
}
ENT.IdleSoundDelay = 4
ENT.ClientIdleSounds = false
ENT.OnDamageSounds = {}
ENT.DamageSoundDelay = 8
ENT.OnDeathSounds = {"elmo/voice/attack/lunge_scream_loop_1.wav"}
ENT.OnDownedSounds = {}
ENT.Footsteps = {}
...
if SERVER then					  --- ... no more sf2? ---

function ENT:OnChaseEnemy(enemy)
	self:StopSound("elmo/voice/idle/hunter_stalk_01.wav")
	self:StopSound("elmo/voice/idle/hunter_stalk_04.wav")
	self:StopSound("elmo/voice/idle/hunter_stalk_05.wav")
	self:StopSound("elmo/voice/idle/hunter_stalk_06.wav")
	self:StopSound("elmo/voice/idle/hunter_stalk_07.wav")
	self:StopSound("elmo/voice/idle/hunter_stalk_08.wav")
	self:StopSound("elmo/voice/idle/hunter_stalk_09.wav")
	if not (self:GetCooldown("elmo") > 0) then
		self:SetCooldown("elmo", 5)
		self:EmitSound("elmo/voice/attack/shriek_1.wav")
	end
end

function ENT:OnDeath(dmg, hitgroup)
	self:StopSound("elmo/voice/attack/shriek_1.wav")
	self:StopSound("elmo/music/pzattack/exenteration.wav")
end
...
function ENT:OnSpawn()
	self:EmitSound("elmo/music/pzattack/exenteration.wav", 511, 100)
end
