...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, -30, -30), angle = Angle(0, 0, 0) },
	["medkit_bone"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
SWEP.VElements = {
	["whiskas"] = { type = "Model", model = "models/whiskas/whiskas.mdl", bone = "medkit_bone", rel = "", pos = Vector(0.483, 2.596, -0.519), angle = Angle(180, 0, -85.325), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["w_whiskas"] = { type = "Model", model = "models/whiskas/whiskas.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.435, 3.454, 2.221), angle = Angle(180, 118.052, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
