AddCSLuaFile()
if(CLIENT)then SWEP.WepSelectIcon=surface.GetTextureID("vgui/wep_jack_hmcd_riotshield");SWEP.BounceWeaponIcon=false end
...
function SWEP:Deploy()
	if SERVER then
		...
		self.shield:SetPos(self.Owner:GetPos() + Vector(0, 0, 40+crouchadd) + (self.Owner:GetForward() * 12.5))
