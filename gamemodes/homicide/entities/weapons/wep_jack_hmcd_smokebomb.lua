...
function SWEP:Throw(speed)
	...
	Bom:Spawn()
	Bom:Activate()
	Bom:GetPhysicsObject():SetVelocity(self.Owner:GetVelocity()+self.Owner:GetAimVector()*speed)
