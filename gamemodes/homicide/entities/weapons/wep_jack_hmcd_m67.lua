...
if(CLIENT)then SWEP.WepSelectIcon=surface.GetTextureID("vgui/hud/tfa_ins2_m67");SWEP.BounceWeaponIcon=false end
...
SWEP.MinExplodeTime=4
SWEP.MaxExplodeTime=5
SWEP.SpoonModel="models/weapons/arc9/darsu_eft/skobas/m67_skoba.mdl"
