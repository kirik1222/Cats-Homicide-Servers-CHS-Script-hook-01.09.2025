...
local BlowoutInterval = CreateConVar( "blowout_interval", 7200, { FCVAR_ARCHIVE }, "The time in seconds between two blowouts (from the previous blowout's damage phase to the next one's announcement).")
local AnnounceDuration = CreateConVar( "blowout_announcing_duration", 300, { FCVAR_ARCHIVE }, "The delay in seconds until a blowout sequence starts, after it's been announced.")
local DamageDuration = CreateConVar( "blowout_damage_duration", 180, { FCVAR_ARCHIVE }, "The duration in seconds, after a blowout has hit, during which Wiremod E2s cannot be used.")
